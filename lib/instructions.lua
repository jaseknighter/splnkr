...
instructions.display = function ()
  ...
  if pages.index == 1 then
    ...
    elseif (sample_player.nav_active_control == 4) then
      ...
      screen.text("k1 + e2: select cutter")
      screen.move(5, 52)
      screen.text("k1 + e3: move cutter")
      screen.move(5, 60)
      screen.text("k1 + e1: fine move cutter")
